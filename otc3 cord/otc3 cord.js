...
function indicators(){
	...
	for(active_bind in active_binds){
		...
		var right_shift = ((betterScopeActive) ? (-GetValue("Better scope thickness") - 12) : 0);
		...
		Render.String(screen_size[0] / 2 - right_shift + 1, screen_size[1] / 2 + binds_offset, 1, name, [0, 0, 0, 125], 3);
		Render.String(screen_size[0] / 2 - right_shift, screen_size[1] / 2 + binds_offset, 1, name, color, 3);
